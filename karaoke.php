...
<div class="nav-bar">
	...
	<div id="inline">
			...
			<a href="karaoke.php" class="pages active">Karaoke</a>
...
?>
    ...
    <div class="main" style="margin-top: 100px;">
      <div id="filedrag">Drop your MP3 file here (or .ogg or .wav)</div>
      <div id="fileselect-container">
        <label for="fileselect">Or select a file:
        
		<input type="file" id="fileselect" name="fileselect[]"></input></label>
      </div>
...
function displayAudios(){
	...
	while($row = mysqli_fetch_array($r)){
		...
		echo '<li><a href="karaoke.php?name='.$row['filename'].'" style = "cursor: pointer"><button id="playButton" class="fa fa-play playButton"></button>&nbsp;&nbsp;&nbsp;'.$song[0].'</a></li>';
	}
