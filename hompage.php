...
<div class="category">
<ul>
<a href="homepage.php"><div id="inline">
<li>Songs</li>
</div></a>
<div id="inline" class="active"><li>Playlist</li></div>
</ul>
</div>
<div>
<div id="songs">
...
echo '<a href="homepge.php?number=30"><div class="mybox" style="height:200px; width:400px;"><h1>Rock</h1><div class="img rock"></div></div></a>';
echo '<a href="homepge.php?number=25"><div class="mybox" style="height:200px; width:400px;"><h1>Sufi</h1><div class="img sufi"></div></div></a>';
echo '<a href="homepge.php?number=20"><div class="mybox" style="height:200px; width:400px;"><h1>Romance</h1><div class="img romance"></div></div></a>';
echo '<a href="homepge.php?number=15"><div class="mybox" style="height:200px; width:400px;"><h1>Party</h1><div class="img party"></div></div></a>';
